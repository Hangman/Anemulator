...
public class DecL extends Instruction {
    ...
    public DecL(Register register, MemoryBankController memory) {
    ...
    @Override
    public int run() {
        final int newValue = this.register.get(RegisterId.L) - 1;
        this.register.set(RegisterId.L, newValue & 0xFF);
