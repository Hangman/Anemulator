...
public class DecB extends Instruction {
    ...
    public DecB(Register register, MemoryBankController memory) {
    ...
    @Override
    public int run() {
        final int newValue = this.register.get(RegisterId.B) - 1;
        this.register.set(RegisterId.B, newValue & 0xFF);
